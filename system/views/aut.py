...
class Authenticator:
    def __init__(self):
        '''Construye un autentificador para administrar
         el login y logout de los usuarios.'''
        self.users = {}
...
class Authorizor:
    ...
    def add_permission(self, perm_name):
        '''Crear un nuevo permiso en el que el usuario
        pueda ser incluido'''
        try:
    ...
    def permit_user(self, perm_name, username):
        '''Adjudica el permiso indicado al usuario'''
        try:
            perm_set = self.permissions[perm_name]
        except KeyError:
